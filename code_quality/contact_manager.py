...
def main() -> None:
    """ main entry """
    contact_manager_instance_1 = ContactManager()
    print(contact_manager_instance_1)
    print(contact_manager_instance_1.__dict__)
    print(type(contact_manager_instance_1.list_contacts()))

    # print(contact_manager_instance_1._contacts)
    print(contact_manager_instance_1.list_contacts())
    contact_manager_instance_1.add_contact("Alice")
    contact_manager_instance_1.add_contact("Bob")
    # print(contact_manager_instance_1._contacts)
    print(contact_manager_instance_1.list_contacts())
